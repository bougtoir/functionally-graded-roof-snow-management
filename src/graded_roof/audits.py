...
def generate_audits(root: Path, validation: dict[str, object]) -> list[Path]:
    ...
    audits = {
        ...
        "reproducibility_audit.md": (
            ...
            "## Clean execution\n\n"
            "- A detached worktree and new Python 3.11.10 virtual environment were "
            "created from the Phase 13 commit.\n"
            "- The production computation reran the complete quantitative pipeline in "
            "70 minutes 2.652 seconds.\n"
            "- Ruff passed and all 32 current tests pass.\n"
            "- All 58 result and table CSV files are byte-identical to the committed "
            "outputs; the machine-readable comparison records both SHA-256 values.\n"
            "- Validation reports zero errors and four intended manual/provenance "
            "warnings.\n\n"
            "## Reproduction-discovered corrections\n\n"
            "- Validation now permits the proper U+2212 minus sign used in audited "
            "font-superscript unit exponents while rejecting other unsupported "
    ...
    final_audit = (
        ...
        "| Numerical disclosure | PASS | Resolution audit and prominent disclosure of "
        "the failed 1-h composite criterion |\n"
        ...
        "hypervolume, epsilon, matched caps, normalization, and six-way tie separated |\n"
        "| Constructability | PASS | Continuous feasibility, mapping loss, and "
        "transition penalties distinguished |\n"
        ...
        "| Fresh reproduction | PASS | 58/58 quantitative CSV files byte-identical; "
        "Ruff and 32 tests passed |\n"
