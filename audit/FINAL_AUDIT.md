...
| Numerical disclosure | PASS | 0.5-h production reference, failed 1-h comparison, and targeted 0.25-h sensitivity are separated |
| Checkpoint integrity | PASS | 9 timestep-isolated manifests audited |
| Comparison fairness | PASS | Exhaustive 6,300-design uniform grid precedes heuristic heterogeneous comparison |
| Pareto and robustness interpretation | PASS | Unique objective pairs, hypervolume, epsilon, matched caps, normalization, and 6-way tie separated |
| Constructability | PASS | 0 feasible joint rows; mapping movement and transition penalties distinguished |
...
| Provenance | PASS | Five public-source snapshots are tracked with URL, size, checksum, and usage metadata; they are not quantitative inputs |
